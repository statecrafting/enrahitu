 ...
 *
 * The exported client is identical to the Vue flavor's (@enrahitu/frontend) on
 * purpose: spec 015 requires the same auth/API/CSRF paths across flavors, with
 * no flavor-specific behavior. Only this header comment differs between the two
 * files; keep the logic in lockstep.
 */
